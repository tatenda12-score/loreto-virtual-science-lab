...
const REAGENTS = [
  { id: 'iodine', name: 'Iodine Solution', testsFor: 'starch', positiveColor: '#1e1b4b', negativeColor: '#b45309' }, // Blue-black vs amber
  { id: 'biuret', name: 'Biuret Reagent', testsFor: 'protein', positiveColor: '#c084fc', negativeColor: '#3b82f6' }, // Purple vs blue
  { id: 'benedict', name: 'Benedict\\'s Solution (Heat)', testsFor: 'sugar', positiveColor: '#b91c1c', negativeColor: '#3b82f6' }, // Brick red vs blue
  { id: 'ethanol', name: 'Ethanol (Emulsion)', testsFor: 'lipids', positiveColor: '#f8fafc', negativeColor: '#00000000' } // Cloudy white vs clear
];
...
export default function FoodTestsSimulation({ experiment, onClose, onSuccess }: SimulationProps) {
  ...
  const [reactionColor, setReactionColor] = useState('#e2e8f0'); // Default empty tube color
  ...
  // Reset tube when food or reagent changes
  useEffect(() => {
